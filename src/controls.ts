...
export const shareButton = document.getElementById('share') as HTMLButtonElement;
...
// export const settingsIcon = document.getElementById('settingsIcon') as HTMLSpanElement;